...
export default function TranslateHeading({ translateKey,className="", fallbackTitle = "" }: any) {
    ...
    return (
        <Heading title={title || fallbackTitle} sub_title={subtitle} className={className} />
    );
}
